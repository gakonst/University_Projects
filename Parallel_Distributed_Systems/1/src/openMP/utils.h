...
/* morton_encoding.c */
void morton_encoding(unsigned long int *mcodes, unsigned int *codes, int N, int max_level,int T);
...
/* data rearrangment */
void data_rearrangement(float *Y, float *X, unsigned int *permutation_vector, int N,int T);

float compute_range(float max, float min);
